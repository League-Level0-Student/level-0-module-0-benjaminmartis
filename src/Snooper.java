...
public class Snooper {
	...
	JOptionPane.showMessageDialog(null, "Ok thank you "+name+"You live in "+region+ house+", your credit information is "+credit+", your social security number is "+social+". Your information is being stored in our secure servers.");
	}
